...
# À implémenter dans 'TP2. Module SVG'
def genere_balise_debut_groupe(couleur_ligne, couleur_remplissage,
                               epaisseur_ligne):
  """
    ...
    """
  return f'<g fill={couleur_remplissage} stroke ={epaisseur_ligne} stroke-width = {epaisseur_ligne} '

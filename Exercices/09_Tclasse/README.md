...
après exécution de la ligne 5 :<br> ![après ligne 5](svg/tout_est_ref_int_1.svg)

après exécution de la ligne 6 :<br> ![après ligne 6](svg/tout_est_ref_int_2.svg)

après exécution de la ligne 7 :<br> ![après ligne 7](svg/tout_est_ref_int_3.svg)

après exécution de la ligne 8 :<br> ![après ligne 8](svg/tout_est_ref_int_4.svg)
...
![après k = 17](svg/tout_est_ref_int_5.svg)
...
après exécution de la ligne 5 : <br> ![après ligne 5](svg/tout_est_ref_list_1.svg)

après exécution de la ligne 6 : <br> ![après ligne 6](svg/tout_est_ref_list_2.svg)

après exécution de la ligne 8 : <br> ![après ligne 8](svg/tout_est_ref_list_3.svg)
...
après exécution de la ligne 12 : <br> ![après ligne 5](svg/tout_est_ref_params_int_1.svg)

avant exécution de la ligne 7 : <br> ![après ligne 6](svg/tout_est_ref_params_int_2.svg)

après exécution de la ligne 7 : <br> ![après ligne 7](svg/tout_est_ref_params_int_3.svg)

après exécution de la ligne 13 <br> ![après ligne 8](svg/tout_est_ref_params_int_4.svg)
...
après exécution de la ligne 11 : <br> ![après ligne 5](svg/tout_est_ref_params_list_1.svg)

avant exécution de la ligne 7 : <br> ![après ligne 6](svg/tout_est_ref_params_list_2.svg)

après exécution de la ligne 7 mais avant de sortir de la fonction `add_1` : <br> ![après ligne 7](svg/tout_est_ref_params_list_3.svg)

après exécution de la ligne 12 <br> ![après ligne 8](svg/tout_est_ref_params_list_4.svg)
...
![mémoire](svg/triangles_classe.svg)
...
![mémoire](svg/triangles_mystere.svg)
...
![mémoire](svg/is_vs_egal_egal.svg)

...
a=b=c=d=e=2
print(a,b,c,d,e,"sidi") # il y'a un espace par défaut entre deux variables lors de l'affichage
...
print(123456)
print(f"{10:>8d}") # ceci signifie que "10" va prendre 8 espace et situe à droite
